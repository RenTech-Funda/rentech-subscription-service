...
public interface SubscriptionQueryService {
    ...
    Optional<Subscription> getBySubscriptionIdAndOwnerUserId(SubscriptionId subscriptionId, UserId ownerUserId);
    List<Subscription> getByOwnerUserId(UserId ownerUserId);
